...
f=np.load('work/quadratic13.npz');r=float(f['radius']);pts=f['points'];par=f['params'];A,B,va,vb,sa,sb,rawA,rawB=load_images(10,.65)
def norm(raw,v):
...
np.savez('work/quadratic13_reverse.npz',points=pts,params=p,fb_error=fb,**st)
